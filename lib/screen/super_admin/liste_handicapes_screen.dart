...
Future<void> showAddSpecialtyDialog(BuildContext context) async {
  ...
  final _handicapData = <String, dynamic>{};
  ...
  return showDialog<void>(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text('Add Handicape',textAlign: TextAlign.center,),
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  onSaved: (value) {
                    _handicapData['description'] = value;
                  },
                  maxLines: 3,
                ),
              ],
