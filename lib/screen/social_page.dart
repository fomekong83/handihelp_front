...
import 'package:handihelp/screen/login_screen.dart';
        ...
        child: Column(
          children: [
            DelayedAnimation(
              ...
              child: Container(
                height: 280,
                child: Image.asset('assets/images/handicape1.webp'),
              ),
            ),
            DelayedAnimation(
              delay: 2500,
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        shape: StadiumBorder(), backgroundColor: AppColor.d_red,
                    ...
                    //AUTHENTIFICATION PAR TELEPHONE
                    ElevatedButton(
                      onPressed: () {
                       Navigator.of(context).pushNamed("/telephone_login");
                      },
                      style: ElevatedButton.styleFrom(
                        shape: StadiumBorder(), backgroundColor: Colors.white,
                        padding: EdgeInsets.all(13),
